...
namespace Server.Net
{
    public class UserProxy
    {
        ...
        /// </summary>
        private List<IServerNetworkProvider> _networkProviders;
        ...
        {
            Id = id;
            _networkProviders = new List<IServerNetworkProvider>();
        }
        ...
        public void AddConnection(IServerNetworkProvider serverNetworkProvider)
        {
