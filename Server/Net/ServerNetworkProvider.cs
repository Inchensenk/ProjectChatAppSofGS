...
namespace Server.Net
{
    ...
    /// </summary>
    public class ServerNetworkProvider : IServerNetworkProvider
    {
        #region События
        ...
        /// </summary>
        public event Action<byte[], IServerNetworkProvider> BytesReceived;
        ...
        ITransmitterAsync INetworkProvider.Transmitter => throw new NotImplementedException();
